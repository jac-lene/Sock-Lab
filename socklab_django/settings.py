"""
Django settings for socklab_django project.
...
REST_FRAMEWORK = {
    # Use Django's stan dard `django.contrib.auth` permissions,
...
ROOT_URLCONF = 'socklab_django.urls'
...
WSGI_APPLICATION = 'socklab_django.wsgi.application'
